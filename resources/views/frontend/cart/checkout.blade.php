...
@section("title","Vietpro Store - Checkout ")
@section("main")
<!-- main -->
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-5">
					...
					<ul>
						<li>
							...
							<ul>
								...
								<li><span>{{$item->qty}} x {{$item->name}}</span> <span>₫ {{$item->qty}}*{{$item->price}}</span></li>
				...
				<div class="row">
					<div class="col-md-12">
						<p><button type="submit" href="/gio-hang/order-complete.html" class="btn btn-primary">Thanh toán</button></p>
					</div>
				</div>
				@csrf
				</form>
