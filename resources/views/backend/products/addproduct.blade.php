                        ...
                        <form action="/admin/product/store" method="POST" enctype="multipart/form-data">
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="categories_id" class="form-control" value="{{old('category')}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <img id="avatar" class="thumbnail" width="100%" height="350px" src="../uploads/import-img.png">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Thông tin</label>
                                            <textarea name="info" style="width: 100%;height: 100px;" value="{{old('info')}}">{{old('info')}}</textarea>
                                        </div>
                                     </div>
